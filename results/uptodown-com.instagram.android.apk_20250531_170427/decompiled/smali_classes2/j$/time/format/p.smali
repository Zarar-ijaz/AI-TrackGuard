...
.method constructor <init>(Lj$/time/temporal/o;Lj$/time/format/DateTimeFormatter;)V
    ...
    invoke-interface {p1, v3}, Lj$/time/temporal/o;->u(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/o;->f(Lj$/time/temporal/r;)Z
    ...
    :try_start_0
    invoke-interface {p1, v6}, Lj$/time/temporal/o;->r(Lj$/time/temporal/r;)J
    ...
    invoke-static {v2, v3, v5, v6}, Lj$/time/Instant;->H(JJ)Lj$/time/Instant;
    ...
    .line 0
    :goto_2
    invoke-interface {v4, p1, v1}, Lj$/time/chrono/m;->y(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    ...
    :cond_7
    :try_start_1
    invoke-virtual {v1}, Lj$/time/ZoneId;->D()Lj$/time/zone/f;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/o;->j(Lj$/time/temporal/r;)I
    ...
    invoke-virtual {v7}, Lj$/time/ZoneOffset;->J()I
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/o;->f(Lj$/time/temporal/r;)Z

    move-result v1

    if-eqz v1, :cond_c

    invoke-interface {v4, p1}, Lj$/time/chrono/m;->k(Lj$/time/temporal/o;)Lj$/time/chrono/b;
    ...
    invoke-virtual {v7}, Lj$/time/temporal/a;->v()Z
    ...
    invoke-direct {v0, v5, p1, v4, v3}, Lj$/time/format/o;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/o;Lj$/time/chrono/m;Lj$/time/ZoneId;)V
