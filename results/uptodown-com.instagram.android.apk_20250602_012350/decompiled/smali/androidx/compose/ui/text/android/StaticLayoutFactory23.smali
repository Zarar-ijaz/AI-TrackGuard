...
.method public create(Landroidx/compose/ui/text/android/StaticLayoutParams;)Landroid/text/StaticLayout;
    ...
    .line 21
    invoke-static {v0, v1, v2, v3, v4}, Landroidx/compose/ui/text/android/f;->a(Ljava/lang/CharSequence;IILandroid/text/TextPaint;I)Landroid/text/StaticLayout$Builder;
    ...
    .line 29
    invoke-static {v0, v1}, Landroidx/appcompat/widget/z;->a(Landroid/text/StaticLayout$Builder;Landroid/text/TextDirectionHeuristic;)Landroid/text/StaticLayout$Builder;
    ...
    .line 36
    invoke-static {v0, v1}, Landroidx/compose/ui/text/android/j;->a(Landroid/text/StaticLayout$Builder;Landroid/text/Layout$Alignment;)Landroid/text/StaticLayout$Builder;
    ...
    .line 43
    invoke-static {v0, v1}, Landroidx/compose/ui/text/android/k;->a(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    .line 50
    invoke-static {v0, v1}, Landroidx/compose/ui/text/android/l;->a(Landroid/text/StaticLayout$Builder;Landroid/text/TextUtils$TruncateAt;)Landroid/text/StaticLayout$Builder;
    ...
    .line 57
    invoke-static {v0, v1}, Landroidx/compose/ui/text/android/m;->a(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    .line 68
    invoke-static {v0, v1, v2}, Landroidx/compose/ui/text/android/n;->a(Landroid/text/StaticLayout$Builder;FF)Landroid/text/StaticLayout$Builder;
    ...
    .line 75
    invoke-static {v0, v1}, Landroidx/compose/ui/text/android/o;->a(Landroid/text/StaticLayout$Builder;Z)Landroid/text/StaticLayout$Builder;
    ...
    .line 82
    invoke-static {v0, v1}, Landroidx/compose/ui/text/android/p;->a(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    .line 89
    invoke-static {v0, v1}, Landroidx/compose/ui/text/android/g;->a(Landroid/text/StaticLayout$Builder;I)Landroid/text/StaticLayout$Builder;
    ...
    .line 100
    invoke-static {v0, v1, v2}, Landroidx/compose/ui/text/android/h;->a(Landroid/text/StaticLayout$Builder;[I[I)Landroid/text/StaticLayout$Builder;
    ...
    .line 142
    :cond_2
    invoke-static {v0}, Landroidx/compose/ui/text/android/i;->a(Landroid/text/StaticLayout$Builder;)Landroid/text/StaticLayout;
