...
.method public final synthetic findAny()Ljava/util/Optional;
    ...
    invoke-interface {v0}, Lj$/util/stream/Stream;->findAny()Lj$/util/B;

    move-result-object v0

    invoke-static {v0}, Lj$/util/d;->m(Lj$/util/B;)Ljava/util/Optional;
...
.method public final synthetic findFirst()Ljava/util/Optional;
    ...
    invoke-interface {v0}, Lj$/util/stream/Stream;->findFirst()Lj$/util/B;
...
.method public final synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->max(Ljava/util/Comparator;)Lj$/util/B;

    move-result-object p1

    invoke-static {p1}, Lj$/util/d;->m(Lj$/util/B;)Ljava/util/Optional;
...
.method public final synthetic min(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->min(Ljava/util/Comparator;)Lj$/util/B;
...
.method public final synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->reduce(Ljava/util/function/BinaryOperator;)Lj$/util/B;
